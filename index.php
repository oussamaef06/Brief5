    ...
    <header class="absolute inset-x-0 top-0 z-50">
      <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
          <a href="dashboard.php" class="text-sm font-semibold leading-6 text-gray-900">Dashboard<span
    ...
    <div class="relative isolate px-6 pt-14 lg:px-8">
      ...
      <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        <div class="text-center">
          <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Connect, Buy, Sell <br> Your Marketplace for Endless Possibilities!
          </h1>
          <p class="mt-6 text-lg leading-8 text-gray-600">Avito, where buying and selling meet seamlessly. Discover a world of opportunities with a click – your go-to platform for hassle-free transactions.</p>
...
<section class="bg-white">
    <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        <nav class="flex flex-wrap justify-center -mx-5 -my-2">
            <div class="px-5 py-2">
                <a href="#" class="text-base leading-6 text-black-500 hover:text-blacky-900">
                    About
                </a>
            </div>
            <div class="px-5 py-2">
        ...
        <div class="flex justify-center mt-8 space-x-6">
            <a href="#" class="text-black-400 hover:text-black-500">
        ...
        <p class="mt-8 text-base leading-6 text-center text-black-400">
            © 2023 Avito, Inc. All rights reserved.
        </p>
    </div>
</section>
